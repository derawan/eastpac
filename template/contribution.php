                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="number" class="form-control" style="border:1px solid #f39c12" id="est">
                                  ...
                                  <div class="col-md-1" style=" text-align: center; margin-top:40px"><i class="fa fa-exchange"></i></div>
                                   <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                      <input type="number" class="form-control" style="border:1px solid #f39c12" id="eth">
                  ...
                  <div class="row">
                       <div class="col-md-12">
                          <div class="box box-solid box-warning">
                            ...
                            <div class="box-body">
                                <h6>EXCHANGE RATE</h6>
                                <h3>1 ETH = <b style="color:#f39c12">100 EAST</b></h3>
                                <hr>
                                <!-- countdown-->
