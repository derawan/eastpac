                    ...
                    <div class="box-body">
                        <p>Verify your identity to participate in tokensale.</p>
                          ...
                          <div class="status status-empty">
                                ...
                                <p><i class="fa fa-info-circle" style="color:#f39c12"></i> Please type carefully and fill out the form with your personal details. You can’t edit these details once you submitted the form.</p>
                                <div class="row">
                                    <div class="col-md-6">
                              ...
                              <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <br>
                                     <label id="upload"> Upload Your Identity Card Here
                                        <input type="file" id="File"   size="60" >
                                      </label> 
                                </div>
                                <div class="col-md-4">
                                    <img src="dist/img/vector-passport.png">
                                </div>
                              </div>
                              <!-- end col -->
                              ...
                              <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="kyc-thank-you.php" class="btn btn-warning">Submit</a>
                                    </div>
